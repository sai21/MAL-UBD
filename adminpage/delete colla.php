...
{
		$queryupdate="DELETE FROM collaborationinfo WHERE colid='$colidupdate'";
...
<form name="form1" method="post" action="">
  DELETE COLLABORATION INFORMATION
</form>
  ...
  <table width="80%" border="0">
    ...
    <tr>
      ...
      <td width="86%"><label>
        ...
        <input name="editname" type="text" id="editname" value="<?php echo $cn;?>" size="80" readonly="readonly" />
      </label></td>
    </tr>
    <tr>
      ...
      <td width="86%"><label>
        ...
        <input name="editdetail" type="text" id="editdetail" value="<?php echo $d;?>" size="80" readonly="readonly" />
      </label></td>
    </tr>
    <tr>
      <td>Period    :</td>
      <td width="86%"><label>
        ...
        <input name="editperiod" type="text" id="editperiod" value="<?php echo $p;?>" size="80" readonly="readonly" />
      </label></td>
    </tr>
    <tr>
      <td>Link :</td>
      <td width="86%"><label>
        ...
        <input name="editlink" type="text" id="editlink" value="<?php echo $l;?>" size="80" readonly="readonly" />
      </label></td>
    </tr>
  </table>
  <p>
    <label>
      <input type="submit" name="update" id="update" value="DELETE" onclick="successupdate()"/>
    </label>
  </p>
</form>
<p>&nbsp;</p>
...
function successupdate() {
    alert("Your Collaboration Information is successful Delete");
}
