  ...
  <table width="80%" border="0">
    ...
    <tr>
      ...
      <td width="90%"><label>
        ...
        <input name="edittitle" type="text" id="edittitle" value="<?php echo $tt;?>" size="80" />
      </label></td>
    </tr>
    <tr>
      <td>Date  :</td>
    ...
    <tr>
      ...
      <td width="90%"><label>
        ...
        <input name="editinfo" type="text" id="editinfo" value="<?php echo $inf;?>" size="80" />
      </label></td>
    </tr>
    <tr>
      <td>Writen By :</td>
      <td width="90%"><label>
        ...
        <input name="editwrittenby" type="text" id="editwrittenby" value="<?php echo $wrby;?>" size="80" />
      </label></td>
    </tr>
  </table>
  <p>
...
if(isset($_POST['update']))
{
		...
		$queryupdate="UPDATE news SET title='$titleupdate',date='$dateupdate',info='$infoupdate',writtenby='$writtenbyupdate' WHERE newsid='$newsidupdate'";
...
function successupdate() {
    alert("Your News is successful Updated");
}
