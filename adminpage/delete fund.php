...
{
		$queryupdate="DELETE FROM fund WHERE id='$fundidupdate'";
  ...
  <table width="80%" border="0">
    ...
    <tr>
      ...
      <td width="86%"><label>
        ...
        <input name="editname" type="text" id="editname" value="<?php echo $n;?>" size="80" readonly="readonly" />
      </label></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
...
function successupdate() {
    alert("Your Fund Information is successful Delete");
}
