...
{
		$queryupdate="DELETE FROM researchteam WHERE grouporder='$currentgo'";
  ...
  <table width="80%" border="0">
    ...
    <tr>
      ...
      <td width="87%"><label>
        ...
        <input name="groupnamevar" type="text" id="groupnamevar" value="<?php echo $gg;?>" size="70" readonly="readonly"/>
      </label></td>
    </tr>
    <tr>
      <td>Member Name :</td>
      <td><label>
        <input name="namevar" type="text" id="namevar" value="<?php echo $n;?>" size="70" readonly="readonly" />
      </label></td>
    </tr>
    <tr>
      <td>Position :</td>
      <td><label>
        <input name="positionvar" type="text" id="positionvar" value="<?php echo $p;?>" size="70" readonly="readonly" />
      </label></td>
    </tr>
    <tr>
      <td>Expertise :</td>
      <td><label>
        <input name="expertisevar" type="text" id="expertisevar" value="<?php echo $ex;?>" size="70" readonly="readonly" />
      </label></td>
    </tr>
    <tr>
      <td>Contact :</td>
      <td><label>
        <input name="contactvar" type="text" id="contactvar" value="<?php echo $cn;?>" size="70" readonly="readonly" />
      </label></td>
    </tr>
    <tr>
      <td>E-mail Address :</td>
      <td><label>
        <input name="emailvar" type="text" id="emailvar" value="<?php echo $em;?>" size="70" readonly="readonly" />
      </label></td>
    </tr>
  </table>
  <p>
    <label>
      <input type="submit" name="gonow" id="gonow" value="DELETE" onclick="successteamupdate()"/>
    </label>
...
function successteamupdate() {
    alert("Your Team is Delete from the database");
}
